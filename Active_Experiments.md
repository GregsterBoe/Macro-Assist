...
- **Next:** run `Numeric Directional Baseline` from the Actions tab (`exogenous: true`, the default), read the two rows against the comparators, write it up as a KB entry. Blocks nothing.
