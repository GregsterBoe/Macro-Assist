...
- **primary_driver**: one-line thesis. Fill this BEFORE setting confidence_pct — write the reasoning chain first (include cross-horizon discount if applicable, e.g. "T+20 accuracy 70% → T+5 confidence adjusted to 60%"), then derive confidence_pct from what you wrote. Max 350 characters.
